...
public class VaadinRemarksNavBarViewLogic implements IProjectdetailsNavView{
	
	private VaadinRemarksNavBarView view;
	private EventBus eventBus;
	
	public VaadinRemarksNavBarViewLogic(VaadinRemarksNavBarView view, EventBus eventBus) {
		if (view == null) {
