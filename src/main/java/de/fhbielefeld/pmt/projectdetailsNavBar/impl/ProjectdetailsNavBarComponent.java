...
public class ProjectdetailsNavBarComponent extends AbstractPresenter<IModel, IProjectdetailsNavView> implements IProjectdetailsNavComponent{
	
	public ProjectdetailsNavBarComponent( IModel model,IProjectdetailsNavView view, EventBus eventBus) {
