...
public class ClientComponent extends AbstractPresenter<IClientModel, IClientView> implements IClientComponent {
	...
	/**
	 * Nimmt ReadAllClientsEvent entgegen und stößt anschließend über das bekannte Model die
	...
	/**
	 * Nimmt ReadActiveProjectsEvent entgegen und stößt anschließend über das bekannte Model
